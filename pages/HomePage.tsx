    ...
    <>
      <header className="relative z-10 w-full max-w-4xl mx-auto text-center pt-16 pb-20 px-4 animate-in fade-in zoom-in duration-700">
        ...
        <div className="mt-8 flex justify-center gap-4">
          <button onClick={() => navigate('/about')} className="px-6 py-2 rounded-full border border-gray-700 text-sm text-gray-400 hover:text-white hover:border-gray-500 transition-all">Learn More</button>
        </div>
      </header>
